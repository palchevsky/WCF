...
namespace ConverterClient.ServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="ConvertedUnits", Namespace="http://schemas.datacontract.org/2004/07/ConverterHost")]
    ...
    public partial class ConvertedUnits : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        public double Ft {
            ...
            set {
                if ((this.FtField.Equals(value) != true)) {
                    this.FtField = value;
    ...
    public interface IConverter {
        ...
        ConverterClient.ServiceReference.ConvertedUnits LinearMeasure(double meters);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConverter/LinearMeasure", ReplyAction="http://tempuri.org/IConverter/LinearMeasureResponse")]
        System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> LinearMeasureAsync(double meters);
        ...
        ConverterClient.ServiceReference.ConvertedUnits CelsiusToFahrenheit(double c);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConverter/CelsiusToFahrenheit", ReplyAction="http://tempuri.org/IConverter/CelsiusToFahrenheitResponse")]
        System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> CelsiusToFahrenheitAsync(double c);
        ...
        ConverterClient.ServiceReference.ConvertedUnits FahrenheitToCelsius(double f);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConverter/FahrenheitToCelsius", ReplyAction="http://tempuri.org/IConverter/FahrenheitToCelsiusResponse")]
        System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> FahrenheitToCelsiusAsync(double f);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConverterChannel : ConverterClient.ServiceReference.IConverter, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterClient : System.ServiceModel.ClientBase<ConverterClient.ServiceReference.IConverter>, ConverterClient.ServiceReference.IConverter {
        ...
        public ConverterClient.ServiceReference.ConvertedUnits LinearMeasure(double meters) {
            return base.Channel.LinearMeasure(meters);
        }
        
        public System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> LinearMeasureAsync(double meters) {
            return base.Channel.LinearMeasureAsync(meters);
        }
        
        public ConverterClient.ServiceReference.ConvertedUnits CelsiusToFahrenheit(double c) {
            return base.Channel.CelsiusToFahrenheit(c);
        }
        
        public System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> CelsiusToFahrenheitAsync(double c) {
            return base.Channel.CelsiusToFahrenheitAsync(c);
        }
        
        public ConverterClient.ServiceReference.ConvertedUnits FahrenheitToCelsius(double f) {
            return base.Channel.FahrenheitToCelsius(f);
        }
        
        public System.Threading.Tasks.Task<ConverterClient.ServiceReference.ConvertedUnits> FahrenheitToCelsiusAsync(double f) {
